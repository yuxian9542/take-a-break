 ...
 */
export class GooglePlacesRepository {
    apiKey;
    language;
    ...
    async findNearby(params) {
        try {
            ...
            return places.map((place) => ({
                ...place,
                distanceMeters: this.calculateDistance({ lat: params.lat, lng: params.lng }, { lat: place.lat, lng: place.lng })
            }));
        }
        catch (error) {
