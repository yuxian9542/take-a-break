...
import type { PlacesRepository } from '../repositories/places-repository.js';
import type { RouteEngine, RouteMode } from './route-engine.js';
import { RouteEngineError } from './route-engine.js';
import { HeuristicRouteEngine } from './engines/heuristic-engine.js';
...
export class RoutingServiceError extends Error {
  constructor(message: string, public readonly causes: Error[], options?: ErrorOptions) {
