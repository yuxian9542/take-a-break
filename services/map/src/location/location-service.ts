...
import type { LocateRequest, LocationProvider } from '../providers/location-provider.js';
import { LocationProviderError } from '../providers/location-provider.js';
...
export class LocationServiceError extends Error {
  constructor(message: string, public readonly errors: LocationError[], options?: ErrorOptions) {
