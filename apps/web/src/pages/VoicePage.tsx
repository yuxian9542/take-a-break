...
import { getRecentConversations } from '../services/firestore';
        ...
        <header className="voice-header">
          <div className="voice-heading">
            ...
            <p className="subtitle">
              Sign in to start voice conversations with AI companion and access your conversation history.
            </p>
          </div>
        </header>
        <section className="voice-layout">
          <div className="voice-panel voice-panel--chat" aria-label="Authentication">
            <LoginForm />
          </div>
        </section>
      </div>
